...
class HIPAY_MAPI_Order extends HIPAY_MAPI_lockable {
    ...
    /**
     ...
     setShipping($shippingAmount,$shippingTax) cloned by the NBO team
     in order to have a fixed Shipping tax easy to use

    */
	public function setFixedShipping($shippingAmount) {
		if ($this->_locked)
			return false;
